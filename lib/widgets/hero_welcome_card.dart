...
/// Scrollable welcome card — the **first scrollable item** in [HomeScreen].
///
/// Shows:
///  • Personalised time-of-day greeting + username
///  • Mood-aware affirmation of the day (from [MoodAffirmationService])
///  • Today's mood chip (tappable → MoodHistoryScreen)
///
/// The AppBar (brand + icons) is a separate pinned widget in [HomeScreen]
/// and is NOT part of this card.
class HeroWelcomeCard extends StatelessWidget {
  final String? username;

  /// `{'mood': int}` (0–4) when today's mood is known, else null.
  final Map<String, dynamic>? todayMood;

  /// Affirmation string chosen by [HomeScreen] based on [EmotionalState].
